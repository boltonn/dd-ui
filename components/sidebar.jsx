...
export default function Sidebar() {
    ...
    return sidebarItems?.length ? (
        <div className={`relative duration-300 h-screen dark:bg-violet-950 dark:bg-opacity-10 shadow-md border-r mb-3 border-r-violet-700 ${isOpen ? "w-64" : "w-20"} border-r-violet-100`}>
            <HiChevronDoubleLeft
